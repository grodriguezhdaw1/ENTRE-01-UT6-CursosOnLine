...
public class PlataformaCursos
{
    ...
    public void addCurso(String categoria, Curso curso) {
        ...
        if(plataforma.containsKey(categoria)){
            ArrayList cursosexistentes = new ArrayList();
            cursosexistentes = plataforma.get(categoria);
    ...
    public int totalCursosEn(String categoria) {
        ...
        ArrayList cursostotales = new ArrayList();
        cursostotales = plataforma.get(categoria);
    ...
    public TreeSet<String> obtenerCategorias() {
        TreeSet<String> conjNombres = new TreeSet<>();
        conjNombres = plataforma.keySet();
